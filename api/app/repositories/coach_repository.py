...
from database import AudienceInsight, CreatorProfile, TrendReport, User, get_session_factory
...
class CoachContext:
    ...
    recent_trends: list[TrendReport]
...
class CoachRepository:
    ...
    def get_context(self, *, user_id: str) -> CoachContext:
